...
% these are for Unicode characters in the bibliography, add as needed
...
\usepackage{amsmath}
\DeclareMathOperator*{\minimize}{minimize} % such that you can write \minimize_{x} in math equations to display "minimize" with x below it
\DeclareMathOperator*{\maximize}{maximize} % similarly
